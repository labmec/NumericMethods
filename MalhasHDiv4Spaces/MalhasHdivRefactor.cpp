...
int main(){
    ...
    ConfigurateCase test;
    test.SetSimulationCase(SimulationCase2D());
    test.CreateSubStructure();
//
    if (IsMHM_Q) {
        ...
        std::ofstream filefinal2("MHM_Final.txt");
        MHMIxed->Print(filefinal2);
        std::cout<<MHMIxed->NEquations()<<std::endl;
        
        
        std::string name_coarse("Simulation_Results_MHM.vtk");
    ...
    if (IsNo_MHM_Q) {
        ...
        {
            std::ofstream out("gmesh_NoMHM.vtk");
            TPZVTKGeoMesh::PrintGMeshVTK(MIxed->Reference(), out, true);
        }
        
        std::ofstream filefinal2("NoMHM_Final.txt");
        MIxed->Print(filefinal2);
        std::cout<<MIxed->NEquations()<<std::endl;
        
        
        std::string name_coarse("Simulation_Results_NoMHM.vtk");
