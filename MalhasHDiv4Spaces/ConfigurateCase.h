...
class ConfigurateCase {
    ...
    TPZAutoPointer<TPZMHMixedMeshControl> CreateMHMMixedMesh2Spaces();
    TPZAutoPointer<TPZMHMixedMesh4SpacesControl> CreateMHMMixedMesh4Spaces();
   ...
   TPZAutoPointer<TPZMHMixedMesh4SpacesControl> CreateMHMMixedMesh(bool is4Spaces);
